...
public class Testcases extends DriverBase  {
		...
		{			
			...
			WebElement Execute =  driver.findElement(By.xpath(lrobj.accountButton));
		...
		@Test(groups={""})
		public void T02_fillregistrationform () 
		{			
			...
			driver.findElement(By.xpath(lrobj.createAccountButton)).click();
		...
		@Test(groups={""})
		public void T03_goingToAccountsPage () 
		{	//------------------------EXPLICIT WAIT--------------------------		
			WebDriverWait wait=new WebDriverWait(driver,200);
		   	
	   		wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath(hcobj.navverification), 0));
	   		boolean Homeverification= driver.findElements(By.xpath(hcobj.navverification)).size()>0;
	   		softAssertionforHomeVerification.assertTrue(Homeverification);
	   		softAssertionforHomeVerification.assertAll();
			driver.findElement(By.xpath(hcobj.accountButton2)).click();
		...
		@Test(groups={""})
		public void T04_clickeditbutton() throws InterruptedException
		
		{ othersobj.customwait(2000);
			driver.findElement(By.xpath(hcobj.editButton)).click();
			
		}
		
		@Test(groups={""})
		public void T05_emaildisableverification() throws InterruptedException
		...
		@Test(groups={""})
		public void T06_emailVerification() throws InterruptedException
		...
		@Test(groups={""})
		public void T07_hoverClothingNavigationOption() throws InterruptedException
		
		{
			
			Actions  actions = new Actions(driver); 
			WebElement Execute =  driver.findElement(By.xpath(hcobj.clothing));
			othersobj.customwait(2000);
			actions.moveToElement(Execute);
			othersobj.customwait(2000);
			actions.build().perform();
			WebElement  element=driver.findElement(By.xpath(hcobj.allclothing));  
		...
		@Test(groups={""})
		public void T08_clickingAnItempant() throws InterruptedException
		
		{
			
			driver.findElement(By.xpath(hcobj.item)).click();		
}

		@Test(groups={""})
		public void T09_gettingitem1name() throws InterruptedException
		...
		@Test(groups={""})
		public void T10_selectcolor() throws InterruptedException
		
		{
		
			driver.findElement(By.xpath(hcobj.Greycolor)).click();	
			
}		

		@Test(groups={""})
		public void T11_selectsize() throws InterruptedException
		...
		@Test(groups={""})
		public void T12_clickaddtobagbtn() throws InterruptedException
		...
		@Test(groups={""})
		public void T13_clickbagbuttontoviewcart() throws InterruptedException
		...
		@Test(groups={""})
		public void T14_verifyitemname() throws InterruptedException
		...
		@Test(groups={""})
		public void T15_clickbagbuttontoviewcart() throws InterruptedException
		
		{
		
			driver.findElement(By.xpath(hcobj.securecheckout)).click();	
			othersobj.customwait(5000); //we can also put explicit wait
			
}		
		@Test(groups={""})
		public void T16_fillform() throws InterruptedException
		...
		@Test(groups={""})
public void T17_clickcontinuebtn() throws InterruptedException
